...
/*--------------------------
 ...
 |                         |
 --------------------------*/
const enum BALL_STATE { BALL_NORMAL = 0, BALL_DOUBLE_SIZE, BALL_HALF_SIZE, BALL_DOUBLE_SPEED, BALL_HALF_SPEED };
...
/*--------------------------
 ...
 |                         |
 --------------------------*/
const enum BALL_COLLISION { BALL_MISS_PADDLE = 0, BALL_COLLIDED };
...
/*----------------------------
 ...
 |                           |
 ----------------------------*/
const enum PADDLE_STATE { NORMAL = 0, PAD_DOUBLE_SIZE,  PAD_HALF_SIZE};
...
/*------------------------------
 ...
 |                             |
 ------------------------------*/
const enum ORIGINAL_WINDOW_SIZE { WIN_WD = 800, WIN_HT = 800 };
...
struct Brick {
	...
	void draw()
	{
		...
		DrawRectangleRoundedLines(rect(), 0.2f, 4, 2.0f, DARKGRAY); // Draw rectangle with rounded edges outline
	}
};
